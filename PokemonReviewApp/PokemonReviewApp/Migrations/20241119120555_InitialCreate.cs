        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PokemonOwnerOwnerId = table.Column<int>(type: "int", nullable: true),
                    PokemonOwnerPokemonId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.PokemonOwnerPokemonId, x.PokemonOwnerOwnerId },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonCategories_PokemonOwners_PokemonOwnerPokemonId_PokemonOwnerOwnerId",
                        columns: x => new { x.PokemonOwnerPokemonId, x.PokemonOwnerOwnerId },
                        principalTable: "PokemonOwners",
                        principalColumns: new[] { "PokemonId", "OwnerId" });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonCategories_PokemonOwnerPokemonId_PokemonOwnerOwnerId",
                table: "PokemonCategories",
